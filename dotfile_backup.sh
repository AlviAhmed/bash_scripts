...
cp -urv ~/bash_scripts/.  /media/al/Backup Plus/linux_experimental_backup_with_terminal/al/Document/Git_Projects/bash_scripts/

printf "Backing up dot files to usb" 
cp -urv ~/Documents/Git_Projects/dot_config_files/.  /media/al/Backup Plus/linux_experimental_backup_with_terminal/al/Document/Git_Projects/dot_config_files/
